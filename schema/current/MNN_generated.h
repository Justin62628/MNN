...
enum OpType {
  ...
  OpType_CustomSoftsplat = 605,
  OpType_MIN = OpType_AbsVal,
  OpType_MAX = OpType_CustomSoftsplat
};
...
inline const char *EnumNameOpType(OpType e) {
  if (e < OpType_AbsVal || e > OpType_CustomSoftsplat) return "";
